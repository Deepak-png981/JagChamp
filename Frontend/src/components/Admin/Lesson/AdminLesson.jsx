        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="lg:w-1/2">
                <Link to={`/admin/lesson-update/${lesson._id}`}>
                    <button className="mt-4 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-300">
                        Edit
                    </button>
                    <button className="mt-4 ml-4 bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-red-300" onClick={handleDeleteLesson}>
                        Delete
                    </button>
                </Link>
            </div>
                ...
                <div className="lg:w-1/2 mb-8 lg:mb-0">
                    <div className="bg-white shadow-md rounded-lg overflow-hidden">
                        <div className="p-4">
                            ...
                            {/* <p className="mt-2 text-gray-600">check : {JSON.stringify(lesson)}</p> */}
                        </div>
